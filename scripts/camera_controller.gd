...
func _process(delta: float) -> void:
	...
	if Input.is_action_pressed("move_rotate_left"):  pivot.rotate_y(deg_to_rad(-rotate_keys_speed * delta))
	if Input.is_action_pressed("move_rotate_right"): pivot.rotate_y(deg_to_rad( rotate_keys_speed * delta))
	if is_orbiting:
